...
namespace HotelProject.WebUI.Controllers
{
    public class AdminContactController : Controller
    {
        ...
        public async Task<IActionResult> Inbox()
        {
            ...
            var responseMessage2 = await client2.GetAsync("http://localhost:5269/api/Contact/GetContactCount");
            var client3 = _httpClientFactory.CreateClient();
            var responseMessage3 = await client3.GetAsync("http://localhost:5269/api/SendMessage/GetSendMessageCount");
        ...
        public async Task<IActionResult> AddSendMessage(CreateSendMessage createSendMessage)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:5269/api/SendMessage", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        //{
        //    var client = _httpClientFactory.CreateClient();
        //    var responseMessage = await client.GetAsync("http://localhost:5269/api/Contact/GetContactCount");
        //    if (responseMessage.IsSuccessStatusCode)
        //    {
        //        var jsonData = await responseMessage.Content.ReadAsStringAsync();
        //        //var values = JsonConvert.DeserializeObject<List<InboxContactDto>>(jsonData);
